...
const char* TokenToString(enum Tokentype token) {
    switch (token) {
        ...
        case TK_LT1: return "TK_LT1";
        case TK_LT2: return "TK_LT2";
        ...
        case TK_NUM1: return "TK_NUM1";
        case TK_NUM2: return "TK_NUM2";
        case TK_RNUM1: return "TK_RNUM1";
        case TK_RNUM2: return "TK_RNUM2";
